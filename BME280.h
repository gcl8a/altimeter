...
struct BME280Settings
{
  public:
	...
	uint8_t tStandby = 1;
	uint8_t filter = 0;
	uint8_t tempOverSample = 5;
	uint8_t pressOverSample = 5;
...
class BME280 : public Altimeter
{
protected:
    enum STATE {STANDBY, MEASURING};
    STATE state = STANDBY;
...
public:
    ...
    uint8_t Init( const BME280Settings& );

	//Software reset routine
	void reset( void );
    void ForceReading(void);
